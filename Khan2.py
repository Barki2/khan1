...
# Decompiled By barki King

# Youtube : No

# uncompyle6 version 

# Original written By BARKI KING

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'Barki'

__copyright = 'All rights reserved . Copyright  Barkl n'

CorrectUsername = 'RASHMII'

CorrectPassword = 'BARKI'
...
/CHANNAL SUBSCRIBE NA KIA TO OK ID NA AYA GI <::::::::::::::::[]
 ...
 Facebook :         MUHAMMAD ISRAR

 Youtube   :        https://www.facebook.com/Barkikhan6
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  BARKI-Ok ' + k + c + user + '  |  ' + pass2
                    ...
                    print '\x1b[1;92m  BARKI-Cp ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  BARKI-Ok  ' + k + c + user + '  |  ' + pass3
